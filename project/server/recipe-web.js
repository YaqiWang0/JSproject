...
<h1 class="whole-title">Emma's Recipes Website</h1>
 <div class='recipe-frame'>
  <div class='recipes'>
    ...
    <a href="http://localhost:4000/addForm"><button class="open-add-screen" >New Recipe</button></a>
    </div>
    </div>
...
formatRecipe: function (recipe) {
    return `
      <li>
        <div class="recipe">
          <a href="http://localhost:4000/detailRecipt?title=${recipe.title}"><span class="recipe-title" data-title="${recipe.title}">
          ${recipe.title}</span></a>
        </div>
      </li>
    `;
...
<a href="http://localhost:4000"><button class="to-add">HomePage</button></a>
</div>
</div>
...
<h1 class="whole-title">Emma's Recipes Website</h1>
 <div class="detail-frame">
  <div class="detail">
    ...
    <a href="http://localhost:4000"><button class="homepage">HomePage</button></a>
    </div>
    </div>
</div>
    </doctype>
